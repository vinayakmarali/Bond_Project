...
String gross = (String)session.getAttribute("gross");

double accruedInterest =(Double.parseDouble(request.getAttribute("accrued").toString()));
%>
...
if(gross==null)
{
%>	<div id="limitDiv"><input type="text" id="limitAmount" name="limitAmount" value="You cannot short sell" readonly="readonly" style="border:0px solid #000000;color: red"></input></div><br/><br/>
<%
}
else
{
%>
Your limit : <div id="limitDiv"><input type="text" id="limitAmount" name="limitAmount" value="<%=gross %>" readonly="readonly" style="border:0px solid #000000;color: #72A4D2;"></input></div><br/><br/>
<%
}
%>
<input type="hidden" name="limit_hidden" value="<%=gross %>"></input>
<input type="hidden" name="directionJs" value="Sell"></input>
